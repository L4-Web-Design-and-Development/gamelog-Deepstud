export default function HeroImage() {
  return (
    <div className="relative h-50%  overflow-hidden m-4">
      <div className="absolute inset-0 blur-sm bg-[url('https://res.cloudinary.com/dducfnlfu/image/upload/v1747162020/heroImage_fidjx6.jpg')] bg-cover bg-center scale-105 blur-xl z-0" />
